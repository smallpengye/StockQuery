/**
 * Created by 志鹏 on 2017/3/2.
 */
var app = angular.module('myapp', []);
app.controller('newQueryStock', function ($scope,$http) {
    ...
    $scope.forcaseStock=function () {
        $http({
            ...
            if(data.roles=="admin"||data.roles=="member"){
                window.location.href = '../html/forcaseStock.html';
            }else {
               alert("您还没有权限哦！");
            }
        })
